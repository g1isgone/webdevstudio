...
const updatePage = async () => {
  ...
  const citrusFruits = fruitsArray.filter((item) => {
    return item.genus == 'Citrus';
  });
  console.log(citrusFruits);
  // TODO: Append your new element to the page
  const exampleAddElement = citrusFruits.map((item) => {
    ...
    const existingElement = document.getElementById('fruitList');
